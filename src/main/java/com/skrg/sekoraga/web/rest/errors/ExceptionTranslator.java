package com.skrg.sekoraga.web.rest.errors;
...
import com.skrg.sekoraga.web.rest.errors.custom.UsernameAlreadyUsedException;
...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
    ...
    public ResponseEntity<Problem> handleEmailAlreadyUsedException(
            com.skrg.sekoraga.web.rest.errors.custom.EmailAlreadyUsedException ex, NativeWebRequest request) {
    ...
    public ResponseEntity<Problem> handleInvalidPasswordException(
            com.skrg.sekoraga.web.rest.errors.custom.InvalidPasswordException ex, NativeWebRequest request) {
